...
import edu.wpi.first.wpilibj2.command.SequentialCommandGroup;
  ...
  public AutoRightShootSpeaker (ArmSubsystem mArmSubsystem, LauncherSubsystem mLauncherSubsystem, IntakeSubsystem mIntakeSubsystem,SwerveDriveSDS m_driveTrain) {
